...
<%
    ...
    List<ProductoBD> listaProductos = con.obtenerProductosBD(2); 
%>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Partes de Abajo - Luxury ETSE</title>
...
<body class="bg-dark text-white d-flex flex-column min-vh-100">
    ...
    <main class="container my-5 flex-grow-1">
        <div class="text-center mb-5">
            <h1 class="metallic-text">PARTES DE ABAJO</h1>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            %>
                <div class="col-12 text-center">
                    <p class="lead">No hay pantalones en stock ahora mismo, lo sentimos mucho.</p>
                </div>
            <% } %>
        </div>
    </main>
